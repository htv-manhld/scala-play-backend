...
class KafkaEventPublisher @Inject()(
  ...
  private def serializeEvent(event: DomainEvent): play.api.libs.json.JsValue = {
    ...
    event match {
      case e: NotificationCreated => Json.toJson(e)(NotificationCreated.format)
      case e: NotificationSent => Json.toJson(e)(NotificationSent.format)
      case e: NotificationDelivered => Json.toJson(e)(NotificationDelivered.format)
      case e: NotificationFailed => Json.toJson(e)(NotificationFailed.format)
